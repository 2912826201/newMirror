...
class ActivityWaterDropHeader extends RefreshIndicator {
  /// refreshing content
  ...
  State<StatefulWidget> createState() {
    ...
    return _ActivityWaterDropHeader();
  }
}

class _ActivityWaterDropHeader extends RefreshIndicatorState<ActivityWaterDropHeader>
  ...
  void onOffsetChange(double offset) {
    ...
    final double realOffset =
        offset - 44; //55.0 mean circleHeight(24) + originH (20) in Painter
