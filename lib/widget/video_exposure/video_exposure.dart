...
import 'package:mirror/widget/video_exposure/render_video_exposure.dart';
...
class VideoExposure extends SingleChildRenderObjectWidget {
  ...
  void updateRenderObject(BuildContext context, RenderVideoExposure renderObject) {
    ...
    renderObject.onExposure = onVisibilityChanged;
  }
}

typedef VideoExposureCallback = void Function(VideoVisibilityInfo info);
