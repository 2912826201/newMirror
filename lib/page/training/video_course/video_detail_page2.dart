...
/// 视频详情页
class VideoDetailPage2 extends StatefulWidget {
  const VideoDetailPage2({Key key, this.heroTag, this.liveCourseId, this.videoModel}) : super(key: key);
  ...
  @override
  createState() {
    return VideoDetailPage2State(heroTag: heroTag, videoCourseId: liveCourseId, videoModel: videoModel);
  }
}

class VideoDetailPage2State extends State<VideoDetailPage2> {
  VideoDetailPage2State({Key key, this.heroTag, this.videoCourseId, this.videoModel});
