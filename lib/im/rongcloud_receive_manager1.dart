...
abstract class RongCloudReceiveManager1 {
  //获取单例
  static RongCloudReceiveManager1 shareInstance(){
    if (_me==null){
      _me = _RongCloudReceiveManager1();
    }
    return _me;
  }
  ...
  static RongCloudReceiveManager1 _me;
  //是否开启离线消息缓冲
...
class _RongCloudReceiveManager1 extends RongCloudReceiveManager1{
  static bool _activeBuffer = true;
   _RongCloudReceiveManager1(){
     _init();
   }
   //初始化工作
   _init(){
  ...
  //融云回调
   ...
   void _processOffLineRawMsg(Message msg,int left,bool hasPackage){
     switch(_RongCloudReceiveManager1._activeBuffer){
       case true:
         //使用缓冲的情况
