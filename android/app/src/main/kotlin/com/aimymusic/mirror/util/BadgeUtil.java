...
public class BadgeUtil {
    ...
    public static void setBadgeCount(Context context, int count, int iconResId) {
        ...
        }else if (Build.MANUFACTURER.toLowerCase().contains("HUAWEI")|| "Huawei".equals(Build.BRAND)|| "HONOR".equals(Build.BRAND)) {
            //华为
    ...
    private static void setBadgeOfMIUI(Context context, int count, int iconResId) {
        ...
        Notification notification = builder.setPriority(Notification.PRIORITY_LOW).build();
        try {
