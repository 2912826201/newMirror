...
class AppStyle {
  ...
  //黄色
  static const yellowRegular18 = TextStyle(fontSize: 18, fontWeight: FontWeight.w400, color: AppColor.mainYellow);
  static const yellowRegular16 = TextStyle(fontSize: 16, fontWeight: FontWeight.w400, color: AppColor.mainYellow);
  static const yellowRegular14 = TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: AppColor.mainYellow);
