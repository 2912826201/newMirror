...
abstract class InteractiveAreaWidget extends StatefulWidget implements InteractiveProtocol {
 final Widget child;
 InteractiveAreaWidget({Key key,this.child}):assert(child!=null),super(key: key);
...
abstract class RegisterWithInputTemplateState extends State<StatefulWidget> {
  @override
  void initState() {
    super.initState();
  ...
  Widget navigationBar(){
    var leftbackBtn;
    leftbackBtn = SizedBox(child: _backButton,height: 28,width: 28,);
  ...
  ///返回按钮
   ...
   final _themeStyle = TextStyle(
      fontFamily: 'PingFangSC',
      fontSize: 23,
      color: Colors.black,
      decoration: TextDecoration.none);
   final _submitTitleStyle = TextStyle(
      fontFamily: "PingFangSC",
      fontSize: 16,
      color:  Color.fromRGBO(153, 153, 153, 1));
   /// **********************************************
