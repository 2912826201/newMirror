...
class LiveStateAnim extends StatefulWidget {
  final Map<int, Image> imageCaches;
  final double width;
  final double height;
  final Color backColor;

  LiveStateAnim(this.imageCaches, this.width, this.height, this.backColor,
      {Key key})
...
class _WOActionImageState extends State<LiveStateAnim> {
  bool _disposed;
  Duration _duration;
  int _imageIndex;
