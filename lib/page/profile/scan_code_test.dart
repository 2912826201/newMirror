...
class _scanCodeState extends State<ScanCodeTest> {
    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          ...
          leadingWidth: 44,
          title: Text("扫描二维码",style: AppStyle.textMedium18,),
          actions: [
            InkWell(
              onTap: (){
                _getImagePicker();
              ...
              child: Center(child:Container(
                ...
                child: Text("相册",style: AppStyle.textRegular14,),),) ,
            )
          ],
        ),
        body: Stack(
  ...
  _getImagePicker(){
    AppRouter.navigateToMediaPickerPage(
      ...
      if (model != null) {
        ...
        ByteData byteData = await model.croppedImage.toByteData(format: us.ImageByteFormat.png);
