...
/// 视频详情页
class VideoDetailPage1 extends StatefulWidget {
  const VideoDetailPage1(
...
class VideoDetailPage1State extends State<VideoDetailPage1> {
  VideoDetailPage1State(
