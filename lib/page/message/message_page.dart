...
class CreatGroupChatWidgetState extends State<CreateGroupChatWidget> {
  ...
  _createGroupChat() async {
    ...
    //创建请求群聊接口
    createGroupChat(theKeys).then((GroupChatModel dto) {
      print("创建群聊是否成功 $dto");
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        prefixIcon: Image.asset(
                          "images/resource/searchGroup.png",
                        ...
                        suffixIcon: Offstage(
                          child: GestureDetector(
                            ...
                            child: Container(
                              child: Image.asset("images/resource/deleteAll.png"),
                              width: 18.4,
                              height: 18.04,
                            ),
                          ),
                  ...
                  child: Container(
                    child: Row(
                      children: [
                        Expanded(
                            child: GestureDetector(
                          child: CreateGroupChatButton(
                            key: createGroupChatKey,
                          ),
                          onTap: () {
                            _createGroupChat();
                          },
...
class FriendsDataSource implements FriendsDataSourceDelegate {
  ...
  FriendsDataSource() {
    users.addAll(
        [1001531, 1000000, 1008611, 1000111, 1000467, 1001531, 1002549, 1004704, 1021057, 1021479, 1021570, 1022654]);
    users.forEach((element) {
      FriendCellDto dto = FriendCellDto();
      dto.uid = "$element";
      dto.nickName = "$element";
      dto.portraitUrl =
          "http://tiebapic.baidu.com/forum/w%3D580%3B/sign=84189ee79526cffc692abfba893a4b90/0bd162d9f2d3572c228274a29d13632762d0c368.jpg";
      friends.add(dto);
    });
  }
...
class JoinedGroupChatCell extends StatefulWidget {
  ...
  JoinedGroupChatCell(
      ...
      @required this.statusChangeCall})
      : super(key: key);
  final String title;
              ...
              children: [
                Container(
                  decoration: BoxDecoration(
                    image: DecorationImage(image: AssetImage("images/test/temp.png")),
                  ),
                ...
                Spacer(),
                Container(
                  child: Image.asset("images/test/leftNavi.png"),
                  width: 18,
                  height: 18,
      ...
      children: [
        Container(
          child: Text(
            theTitle,
            style: TextStyle(
                fontFamily: "PingFangSC", fontSize: 14, fontWeight: FontWeight.w400, color: AppColor.textPrimary3),
          ),
          height: 28,
...
class FriendsCell extends StatefulWidget {
  ...
  final void Function(dynamic) statusChangeCall;
...
class FriendsCellState extends State<FriendsCell> {
  ...
  Widget _chooseWidget() {
    switch (_chooseStatus) {
      case true:
        return Container(
          decoration: BoxDecoration(image: DecorationImage(image: AssetImage("images/resource/选中.png"))),
          margin: EdgeInsets.only(right: 16),
          width: 24,
          height: 24,
        );
      ...
      default:
        return Container(
          ...
          child: Container(
            decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(9.5), border: Border.all(width: 1, color: AppColor.textHint)),
          ),
        );
        break;
    }
...
class CreateGroupChatButtonState extends State<CreateGroupChatButton> {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Text(
        btnTitle,
        style: TextStyle(color: btnTitleColor, decoration: TextDecoration.none),
      ),
      alignment: Alignment.center,
      decoration: BoxDecoration(color: btnColor, borderRadius: BorderRadius.circular(3)),
    );
  }
}
