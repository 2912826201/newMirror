...
@immutable
class _CustomizeTransitionSnapshotFabLocation extends FloatingActionButtonLocation {

  const _CustomizeTransitionSnapshotFabLocation(this.begin, this.end, this.animator, this.progress);
  ...
  @override
  String toString() {
    return '${objectRuntimeType(this, '_CustomizeTransitionSnapshotFabLocation')}(begin: $begin, end: $end, progress: $progress)';
  }
...
class ScaffoldState extends State<Scaffold> with TickerProviderStateMixin {
  ...
  void _moveFloatingActionButton(final FloatingActionButtonLocation newLocation) {
    ...
    if (_floatingActionButtonMoveController.isAnimating) {
      previousLocation = _CustomizeTransitionSnapshotFabLocation(_previousFloatingActionButtonLocation, _floatingActionButtonLocation, _floatingActionButtonAnimator, _floatingActionButtonMoveController.value);
