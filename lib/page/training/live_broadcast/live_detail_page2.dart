...
/// 直播详情页
class LiveDetailPage2 extends StatefulWidget {
  const LiveDetailPage2({Key key, this.heroTag, this.liveCourseId, this.liveModel, this.isHaveStartTime}) : super(key: key);
  ...
  @override
  createState() {
    return LiveDetailPage2State(heroTag: heroTag, liveCourseId: liveCourseId, liveModel: liveModel);
  }
}

class LiveDetailPage2State extends State<LiveDetailPage2> {
  LiveDetailPage2State({Key key,
    this.heroTag,
    this.liveCourseId,
    this.liveModel});
